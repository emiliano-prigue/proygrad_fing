...
#include "BotonLuz.h"
#include "ModeloForEditMode.h"


// Sets default values
AModeloForEditMode::AModeloForEditMode()
{
...
void AModeloForEditMode::PostInitializeComponents()
{
...
//Recargo Materiales
void AModeloForEditMode::RecargarMateriales()
{
	if (!errorCargaModelo){
		// Apertura de archivo de colores de los poligonos
		FString replaceIn = "/Saved/Config/Windows/Game.ini";
...
void AModeloForEditMode::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AModeloForEditMode::Tick( float DeltaTime )
{
