...
#include "BotonLuz.h"
#include "ModeloUsuarioForEditMode.h"


// Sets default values
AModeloUsuarioForEditMode::AModeloUsuarioForEditMode()
{
...
void AModeloUsuarioForEditMode::PostInitializeComponents()
{
...
//Recargo Materiales
void AModeloUsuarioForEditMode::RecargarMateriales()
{
	if (!errorCargaModelo){
		// Apertura de archivo de colores de los poligonos
		FString replaceIn = "/Saved/Config/Windows/Game.ini";
...
void AModeloUsuarioForEditMode::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void AModeloUsuarioForEditMode::Tick(float DeltaTime)
{
